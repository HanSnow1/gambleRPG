...
public class AugmentDefinition : ScriptableObject
{
  ...
  [Tooltip("If set, passive combat bonus only applies vs this boss gamble type.")]
  public bool restrictToBossGambleType;
  public BossGambleType requiredBossGambleType;
